...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    private void registerBeanDefinitions(Document document) throws IllegalAccessException {
        Element root = document.getDocumentElement();
        parseBeanDefinitions(root);
    }

    private void parseBeanDefinitions(Element root) throws IllegalAccessException {
    ...
    private void processProperty(Element element, BeanDefinition beanDefinition) throws IllegalAccessException {
            ...
            if (node instanceof Element) {
                ...
                if (value != null && value.length() > 0) {
                    ...
                    if (ref == null || ref.length() == 0) {
                        throw new IllegalAccessException("Configuration problem: <property> element for property '"
